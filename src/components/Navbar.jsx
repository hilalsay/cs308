    ...
    <div className='flex items-center justify-between py-5 font medium'>
        ...
        <div className="flex items-center gap-6">
            ...
            <div className="group relative">
                <Link to="/login"><img className="w-20 cursor-pointer" src={assets.gulden_icon} alt="" /> </Link>
            ...
            <img onClick={()=>setVisible(true)} className="w-9 cursor-pointer sm:hidden" src={assets.menu_icon} alt="" />
